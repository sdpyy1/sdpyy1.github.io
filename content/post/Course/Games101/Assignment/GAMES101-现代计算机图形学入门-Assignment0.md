...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/26aaf651fbad47eca926587f0581a4cc.png)
##  使用Eigen表示向量
点$P=(2,1)$ 表示为 `    Eigen::Vector3f point(2, 1, 1);`，最后一位是用于齐次坐标，为1时表示是一个点
##  点旋转矩阵
	**二维点旋转矩阵**比较简单，推导主要是通过设A、B、C、D四个变量，找两个特殊点求解
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/2703bfe2cee44ac4b97c54c3d8b35851.png)
**三维点旋转矩阵**可分解为分别绕三个轴旋转
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/111ec31010d54d3ba088c3f9c8aa8ed2.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/746515aa8ddb49d59c25a6037137c2d4.png)
旋转矩阵的齐次坐标表达为：
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/d4535e0adecb44019c184f1ad6eee1c7.png)
平移 (1,2)，只需要把tx换为1，ty换为2，得到平移矩阵的齐次坐标表达为：
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/a87325807ada4602b8584fd64d17017e.png)
##  旋转和平移组合
得到最终旋转+平移的矩阵为：
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/4fa2012abd2d4722b700bed15d4b3ffa.png)
##  代码实现
